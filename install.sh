...
git clone https://github.com/Untersander/dotfiles ~/dotfiles && cd ~/dotfiles

step "Installing dependencies/fonts/pacman (Font for pacman symobols)"
